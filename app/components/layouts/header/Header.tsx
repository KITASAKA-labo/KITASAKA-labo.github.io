...
export default function Component() {
  ...
  return (
    <nav className="fixed w-100vw bg-white border-b border-gray-300 z-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20">
          <div className="flex-shrink-0 flex items-center">
            <Link href="./index.html" className="text-2xl font-bold text-black hover:text-[#b2c7ff] transition-colors duration-300">
              Lab.KITASAKA
            </Link>
          </div>
              ...
              >
                ...
                {activeMenu === 'contact' && (
                  <div className="absolute right-0 top-full mt-1 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5">
                    ...
                    <Link href="./labo.html" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">研究室情報</Link>
                  </div>
                )}
              </div>
            </div>
